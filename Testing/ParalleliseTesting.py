...
def get_test_data():
    ...
    # code obtains all details from json & database to initiliaze test
    test_data = []
    ...
    # test the test's setting data
    # use this code section to initialize chrome session and login newly created user for the first time, to then
    # manually complete the registration process
...
# main function initializing all different steps within one test iteration
...
if __name__ == '__main__':
    ...
    # crete test run object with given test data and run tests in parallel
    with TestRun(test_data=tests) as test_run:
        ...
        # obtain test results and store them accordingly
